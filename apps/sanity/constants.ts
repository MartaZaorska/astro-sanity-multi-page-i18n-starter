 ...
 * @constant
 */
export const PROJECT_ID: string = 't7uimabz';
 ...
 * @constant
 */
export const API_VERSION: string = '2024-05-24';
 ...
 * @constant
 */
export const STUDIO_HOST: string = 'starter-multi-page-i18n-mz-sanity-studio';
 ...
 * @constant
 */
export const TITLE: string = 'starter-multi-page-i18n';
